 ...
 */
public class ServiceSystemAlertWindowRemoteControl extends Service {
    ...
    public void onCreate() {
        ...
        windowView = (ViewGroup) inflater.inflate(R.layout.system_alert_window_remote_control, null);
        // find view
        buttonClose = windowView.findViewById(R.id.button_close);
        buttonClose.setOnClickListener(v -> {
            Log.d(T, "点击按钮关闭远程控制提示");
            ...
            Intent pushIntent = new Intent("RemoteControlClose");
